...
public class ActividadTest{
    ...
    @Test
    public void deberiaCalcularElNumeroDeCreditosDeUnaActividad(){
        try {
   ...
   @Test
   public void deberiaCalcularCreditosDefinidosDeUnaActividad(){
       assertEquals(23, plan.creditosDefinidos());
   }
}
